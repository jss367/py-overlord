...
<aside class="verdict" aria-label="Recommendation"><span class="eyebrow">Mine engine vs best no-Mine plan</span><strong>{vs_nm}</strong><p>1,000 paired games per opponent. Buy one Mine on turn one or two, play it every turn it can climb, and skip both multipliers.</p><p>Two players · Estate starts · Colony and Platinum · Sewers · Tomb</p></aside>
</header>
...
<li><strong>Buy Sewers with your first spare $3.</strong> It converts every Mine play into two trashes. Let it eat Estates first, then Coppers while you own more than three. Skipping Sewers, skipping Priest, and opening Silver instead of Priest were the three costliest changes tested after skipping Mine.</li>
<li><strong>Priest before Mine when you have the Actions.</strong> Mining Village or Laboratory gives the second Action. Priest trashes an Estate or Copper, then Mine's trash and the Sewers trash each add $2. Skipping Priest lost {pct(rate(FINAL, changes["no_priest"]))} of games to the published engine. Market Square was close to neutral on its own; it is there for the Gold reaction and the +Buy.</li>
...
<li><strong>Money: Platinum at $9, one Gold, one Silver.</strong> Mine manufactures the rest. Add two Laboratories, two Market Squares, and a Mining Village once you own two terminals.</li>
