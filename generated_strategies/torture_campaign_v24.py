...
@retired_strategy(
    ...
    reason="Won 286 of 1,000 confirmation games against version 25; no qualifying advantage on the tested opponent panel.",
    display_name="Torturer and Inn Family, Version 24",
)
