...
CARD_TYPES: dict[str, Type[Card]] = {
    ...
    "Coin of the Realm": CoinOfTheRealm,
    "Page": Page,
    ...
    "Distant Lands": DistantLands,
    "Haunted Woods": HauntedWoods,
    "Hireling": Hireling,
    "Lost City": LostCity,
    "Relic": Relic,
    "Royal Carriage": RoyalCarriage,
