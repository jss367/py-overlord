...
def test_catalog_pages_link_compatible_boards_and_strategies_both_ways(tmp_path):
    ...
    assert {path.relative_to(output).as_posix() for path in written} == {
        ...
        "strategies/suzhou-groundskeeper-strategy-guide.html",
        ...
        "strategies/old-witch-rabble-strategy-guide.html",
        ...
        "strategies/bilbao-shaman-feodum-mill-strategy-guide.html",
        ...
        "strategies/collection-swindler-strategy-guide.html",
