...
def test_render_strategy_pages_writes_index_and_strategy_page(tmp_path):
    ...
    assert paths == {
        ...
        "big-money.html",
        "strategy-retirement-review.html",
        "ninja-watchtower-figurine-strategy-guide.html",
        "ten-strongest-unused-cards.html",
        "strategy-retirement-and-rebuild-comparison.html",
        "recruiter-kitsune-strategy-guide.html",
        "suzhou-groundskeeper-strategy-guide.html",
        "groundskeeper-margrave-strategy-guide.html",
        "sentry-hunting-party-strategy-guide.html",
        "minion-courtier-strategy-guide.html",
        "old-witch-rabble-strategy-guide.html",
